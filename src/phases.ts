...
export const PHASES: PhaseMeta[] = [
  ...
  { id: 'p15', num: 'E1', title: '글자가 숫자로',           subtitle: '글자 → 토큰 → 정수 묶음. 신경망 입력 만들기',              group: 'E. 언어를 다루는 신경망' },
  { id: 'p17', num: 'E2', title: '단어가 좌표로',           subtitle: '이미 학습된 임베딩으로 의미 산수 — 왕 − 남자 + 여자 ≈ 여왕', group: 'E. 언어를 다루는 신경망' },
  { id: 'p18', num: 'E3', title: '신경망으로 임베딩 만들기',  subtitle: '예측→오차→기울기→갱신 흐름을 단어 벡터에 적용',           group: 'E. 언어를 다루는 신경망' },
  { id: 'p22', num: 'E4', title: '다음 단어 맞히기',         subtitle: '어휘 전체에 점수를 매기는 다중분류 — 시드 바꾸면 다른 이야기', group: 'E. 언어를 다루는 신경망' },
